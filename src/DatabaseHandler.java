...
public class DatabaseHandler
{
    ...
    public Warehouse readWarehouse() throws SQLException
    {
        ...
        while (resultSet.next()) {
            ...
            Location aLocation = new Location(row, col);
            Batch aBatch = new Batch(partCode, quantity);
            warehouse.addToWarehouse(aLocation, aBatch);
    ...
    /**
     * Read the customer information; name, address etc.
     *
     * @throws SQLException on SQL error.
     */
